...
public class RobotMap 
{
	...
	public static final int TOTE_SLED_RETRACT_PNEUMATIC_MODULE_ID = 0;
	public static final int TOTE_SLED_EXTEND_PNEUMATIC_MODULE_ID = 1;
	...
	public static final int TOTE_GRABBER_PNEUMATIC_MODULE_ID = 6;
