...
public class HumanLoadCommandListGeneratorSave extends RobotArmCommandListGenerator 
{
...
//	public static final double STACK_Z_POST_UNLOAD_OFFSET = -4; 
	...
	public HumanLoadCommandListGeneratorSave() {	
	...
	public HumanLoadCommandListGeneratorSave(StackPriority stackPriority, int numStacks, int numTotesPerStack) {
...
//				}
    ...
    public static void main(String[] args) {
    	HumanLoadCommandListGeneratorSave humanLoad = new HumanLoadCommandListGeneratorSave(StackPriority.VERTICAL, 1, 6);
